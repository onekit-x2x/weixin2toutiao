...
Component({
    ...
    attached() {
        ...
        var guid = getApp().onekitwx.appid;//onekit.guid();
        ...
        // var url = `https://www.onekitwx.com/weixin2toutiao/app/map.html?guid=${guid}&properties=${encodeURIComponent(JSON.stringify(properties))}`;
        var url = `https://www.onekitwx.com/baidu2toutiao/app/map.html?guid=${guid}&properties=${encodeURIComponent(JSON.stringify(properties))}`;
        this.setData({
            url
        });
        ////////////////////////////////////////////////////
        ...
        this.appSocket = getApp().onekitwx.socket;
        if (this.id) {
            var context = getApp().onekitwx.context[this.id] = {};
